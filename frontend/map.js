import {showNoQuestionnaireAlert, getColorFromRank, getCustomIcon, createClusterCustomIcon, poiConfigs, createMarker, createPolygon} from './utils.js';
        ...
        .then(data => {
            ...
            data.forEach(geofenceData => {
                ...
                if (geofenceData.type === 'marker') {
                    createMarker(map, drawnItems, circles, geofenceData, color, neighborhoodRadius);
